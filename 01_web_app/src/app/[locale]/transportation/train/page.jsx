    ...
    <div className="flex flex-col items-center pb-10 bg-[#f4f7f6] pt-24 ">
      <div className="w-[90%] max-w-md md:max-w-5xl lg:max-w-6xl">
        ...
        <div className="space-y-4 mb-10">
          ...
          <Link href="https://www.jrhokkaido.co.jp/global/index.html" target="_blank" className="bg-white rounded-2xl p-6 shadow-md flex items-center justify-between group hover:shadow-lg transition-shadow">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-3 h-3 rounded-full bg-green-700 shrink-0"></div>
