"""Shared fixtures for node 03 tests. No network, no ML models, no index files."""
...
from runtime import configure_module_paths  # noqa: E402

configure_module_paths()

from agent_core.llm_client import LLMClientError  # noqa: E402
