...
export default function Navbar() {
  ...
  return (
    <>
      <header className="fixed top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-md md:max-w-5xl lg:max-w-[1200px] bg-[#0047b3] text-white rounded-full px-3 md:px-10 py-3 md:py-3 flex justify-between items-center z-40 shadow-lg">

        {/* Left Section: Logo + Desktop Lang Switcher */}
        <div className="flex items-center gap-2 md:gap-10">
          <Link href={`/${locale}`} className="flex items-center">
            <Image src="/illustrations/logo_team.png" alt="SafetyHokkaido" width={25} height={50} priority className="w-[50px] md:w-[50px] h-auto" />
          </Link>
        </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-gradient-to-b from-[#0047b3] to-[#0c8a9e] text-white z-50 p-8 overflow-y-auto w-full h-full">
