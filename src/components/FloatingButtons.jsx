  ...
  return (
    <>
      <div className="fixed bottom-6 right-4 z-40 flex flex-col gap-8 items-center">
        {/* Emergency Contact */}
        <Link href="/emergency-contact" className="relative group transition-transform hover:scale-105 flex flex-col items-center">
          {/* Arced Text SVG */}
          ...
          <div className="w-16 h-16 relative rounded-full overflow-hidden shadow-lg border-[3px] border-white bg-orange-500">
             <Image 
        ...
        >
          ...
          <div className="w-16 h-16 relative rounded-full overflow-hidden shadow-lg border-[3px] border-white bg-blue-500">
             <Image 
