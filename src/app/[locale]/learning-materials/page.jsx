  ...
  return (
    <div className="flex flex-col items-center pb-10 bg-[#f4f7f6] pt-24">
      <div className="w-[90%] max-w-md md:max-w-5xl lg:max-w-6xl">
        ...
        {/* Header */}
        <h1 className="font-torsilp text-5xl md:text-8xl font-black text-black tracking-wider mb-2 md:mb-6 leading-none uppercase" dangerouslySetInnerHTML={{ __html: t.raw('title') }} />
        ...
        <div id="links" className="bg-white rounded-3xl shadow-md p-6 mb-10 md:bg-transparent md:shadow-none md:p-0 md:rounded-none scroll-mt-32">
          ...
          <div className="hidden md:block">
            <h2 className="font-torsilp text-7xl font-black text-black tracking-wider mb-2 mt-12 uppercase">{t('helpDeskTitle')}</h2>
